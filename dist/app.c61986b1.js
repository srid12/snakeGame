...
window.addEventListener("load", function () {
  ...
  document.addEventListener("keydown", function (event) {
    ...
    switch (event.key) {
      case "ArrowLeft":
        if (snakeDirection === "up" || snakeDirection === "down") snakeDirection = "left";
        break;

      case "ArrowRight":
        if (snakeDirection === "up" || snakeDirection === "down") snakeDirection = "right";
        break;

      case "ArrowUp":
        if (snakeDirection === "left" || snakeDirection === "right") snakeDirection = "up";
        break;

      case "ArrowDown":
        if (snakeDirection === "left" || snakeDirection === "right") snakeDirection = "down";
        break;
    }
...
var boardElems = [];
var timerId = null;
var squaresNumber = boardWidth / blockWidth * boardHeight / blockHeight;

function drawGrid() {
  var totalSquares = boardWidth / blockWidth * (boardHeight / blockHeight);
...
function moveSnake() {
  var newPart = snakes[snakes.length - 1];
  var rowSize = boardWidth / blockWidth;
  eventRun = true;
...
},{}]},{},["../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
